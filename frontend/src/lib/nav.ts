...
export const NAV: NavItem[] = [
  {
    ...
    badgeText: "15 Agents Online · 99.8% Health",
    badgeTone: "success",
    path: "/dashboard",
  },
  {
    ...
    subtitle: "Teach all 15 agents about your niche, content style, audience demographics, and deal rules",
  ...
  },
  {
    ...
    badgeText: "15 Nodes · OpenTelemetry",
    badgeTone: "info",
    path: "/fleet",
  },
]
